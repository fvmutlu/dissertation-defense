...
## Toy Example {.smaller visibility="uncounted"}
...
:::
::: {.column width="50%" style="font-size: 95%;"}
![](images/all_tiers.svg){style="display: block; margin-top: 0;"}

-  Addition of second tier capacity impacts performance [*negatively*]{.body-highlight-red}.
-  Diverted traffic approaches rate limit of second tier, making it a bottleneck[^mansilha].
:::
:::

[^mansilha]: "Hierarchical content stores in high-speed ICN routers: Emulation and prototype implementation", Mansilha, Rodrigo B., et al., ACM ICN 2015, @mansilha2015hierarchical.
