...
- **Implementation**: Built using Python and the SimPy library for discrete event simulation.
    - Single-threaded due to DES.
    - Supports execution of multiple simulations via multiprocessing.
:::
...
- [GitHub Action](https://github.com/fvmutlu/multi-tier/actions/workflows/custom-experiment.yml){preview-link="true"} for running experiments and generating plots.
