...
**Goal:** Guarantee stability of all VIP queues, minimize total backlog.

**Penalties:** What happened to them?
...
::: {style="font-size: 80%;"}
Assume $\omega=0$; perform [caching]{.body-highlight} by choosing $r\knjt$ and $s\knjt$ for each $\kin$ and $j \in \mathcal{J}_n$ to:
...
- Why don't we avoid them in original formulation?
