...
::: {.incremental}
• Requests can enter network at any node.
...
::: {.r-stack}
![](images/dpmodel_1.svg){width="648" height="360" fig-align="center"}

![](images/dpmodel_2.svg){.fragment fragment-index=2 width="648" height="360" fig-align="center"}

![](images/dpmodel_3.svg){.fragment fragment-index=3 width="648" height="360" fig-align="center"}
:::
...
[• An object evicted from one tier can [migrate]{.body-highlight} to another tier at the same node.]{.fragment fragment-index=1}

[• Each admission or eviction has an associated [utilization cost]{.body-highlight}.]{.fragment fragment-index=2}
:::
::: {.column width=20%}
::: {.r-stack}
![](images/tier1_admit.svg){.fragment .fade-out fragment-index=1 width="648" height="360" style="display: block; margin-left: auto; margin-right: 10px; transform: translateY(25%);"}

![](images/tier2_admit.svg){.fragment .fade-in-then-out fragment-index=1 width="648" height="360" style="display: block; margin-left: auto; margin-right: 10px; transform: translateY(25%);"}

![](images/migration.svg){.fragment .fade-in fragment-index=2 width="648" height="360" style="display: block; margin-left: auto; margin-right: 10px; transform: translateY(25%);"}
:::
:::
:::
