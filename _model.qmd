...
-   Requests can enter network at any node, forwarded toward sources

![](images/dpmodel_1.svg){width="55%" height="55%" fig-align="center"}
...
## Data Plane Model
 ...
 -   Requests can enter network at any node, forwarded toward sources
-   Responses carry data back, following reverse path

![](images/dpmodel_2.svg){width="55%" height="55%" fig-align="center"}
...
-   Requests can enter network at any node, forwarded toward sources
-   Responses carry data back, following reverse path
-   Nodes can respond from their cache

![](images/dpmodel_3.svg){width="55%" height="55%" fig-align="center"}
...
## VIP Queue Dynamics
[VIP queuing dynamics]{.body-highlight} for object $\kin$ at node $\nin$, where $(x)^+ = max(x,0)$:
