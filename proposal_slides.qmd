...
-  Benefits of ubiquitous caching offered by ICN architectures are more pronounced when caching and forwarding decisions are tightly coupled
   -  "*Coupling caching and forwarding: benefits, analysis, and implementation*", G. Rossini, D. Rossi
...
::: {.fragment}
![... and it's a really big room](images/big-room.webp){width=65% height=65% fig-align="left"}
:::
