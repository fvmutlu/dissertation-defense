...
## Joint Caching and Forwarding Strategies for Networks with Hybrid Storage Systems
- Volume of data grows exponentially, while in-network cache capacities are stagnant
- Rapidly advancing storage technology can be leveraged to extend cache capacities
- Doing so in a cost-effective way requires novel, tailored caching strategies
