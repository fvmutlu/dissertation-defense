...
-  A *virtual interest packet* (*VIP*) is generated alongside each exogenous request entering network; each node maintains a [VIP counter]{.body-highlight} for each object in the network
...
-   Network can determine [weight of penalties]{.body-highlight} via parameter $\omega$
