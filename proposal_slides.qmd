...
-  Cache exclusivity makes [upward migrations]{.body-highlight} difficult
-  Without this constraint, algorithm operates over individual tiers independently; adaptations to baselines unnecessary
