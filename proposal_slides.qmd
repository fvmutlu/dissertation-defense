...
## Key Observations {.incremental}
-  Trying to increase cache sizes with DRAM is cost-prohibitive and faces strict limitations
-  SSDs are a cheap solution and their transfer rates are improving each generation
-  The diminishing returns property emerging from Zipf's law supports the validity of using SSDs
