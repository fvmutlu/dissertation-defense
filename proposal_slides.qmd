...
:::
::: {.column width="50%"}
-  Same catalog and popularity distribution
-  Objects are cached in order of popularity, starting from tier 1 and moving onto next tier when previous one is full
:::
:::
...
::: columns
::: {.column width="50%"}
![](images/two_tiers.svg){.fragment width=75% height=75% fig-align="center"}

::: {.fragment}
-  Although second cache tier operates slower than the line rate, it still improves delay at high request rates
-  This is a direct result of the diminishing returns property emerging from Zipf's law
:::
:::
::: {.column width="50%"}
![](images/three_tiers.svg){.fragment width=75% height=75% fig-align="center"}

::: {.fragment}
-  However, addition of the third tier impacts performance negatively
-  **Lesson**: Cache tiers still need to outpace their own *hit rate*
-  Otherwise, we're replacing link delays with delays at cache controller queues
:::
:::
:::
