...
These works study the implementation of SSD-based caches for ICN routers:

-  *"Multi-Terabyte and multi-Gbps information centric routers"*, Giuseppe Rossini, D. Rossi, M. Garetto, E. Leonardi, INFOCOM 2014
-  *"Toward terabyte-scale caching with SSD in a named data networking router"*, W. So, Taejoong Chung, Haowei Yuan, D. Oran, M. Stapp, ANCS 2014
-  *"Hierarchical Content Stores in High-Speed ICN Routers: Emulation and Prototype Implementation"*, Rodrigo B. Mansilha, Lorenzo Saino, M. Barcellos, Massimo Gallo, E. Leonardi, Diego Perino, D. Rossi, ICN 2015
-  *"Exploiting parallelism in hierarchical content stores for high-speed ICN routers"*, Rodrigo B. Mansilha, Marinho P. Barcellos, Emilio Leonardi, Dario Rossi, COMNET 2017
...
**Interpretation**: We can set $\omega$ arbitrarily large to push the time average penalty close to $\Psi(\boldsymbol{\lambda})$ at the cost of significantly increasing the average queue backlog and vice-versa.
