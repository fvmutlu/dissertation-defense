...
Operate close to VIP network stability region while keeping sum penalty small, thus achieving a balance between user demand rate satisfied and costs incurred.
...
## Appendix A: Other References {.smaller .scrollable}
...
## Appendix B: Model Notation {.smaller .scrollable}
...
## Appendix C: Analysis Notation {.smaller .scrollable}
