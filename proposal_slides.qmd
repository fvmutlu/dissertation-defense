...
-  This policy needs to:
   -  Balance the frequency of cache hits served by each cache tier based on their transfer rates
   -  Be adaptable to changing traffic patterns in the network
   -  Offer a performance guarantee and lend itself to distributed implementation
