...
When request for $k \not \in \bigcup_{\jin} \mc{K}_{n_j}(\tau)$ arrives at $n$ at instance $\tau$, [data plane forwarding policy]{.body-highlight} forwards it to[^dpfwd]:
...
[^dpfwd]: This follows from Yeh et al. (2014) @yeh2014vip.
