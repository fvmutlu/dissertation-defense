...
::: {style="font-size: 90%;"}
Considerations for mapping virtual plane algorithm to data plane:

- Data plane requires a [caching policy]{.body-highlight} and a [forwarding policy]{.body-highlight} operating in real time.
...
We use virtual plane *flow trends* to guide data plane policies.
:::
