...
- We seek an algorithm that can:
    ...
    - Keep cache utilization costs minimal.
- Placeholder.
...
Algorithm achieves following [trade-off]{.body-highlight} for arrival rate vector $\boldsymbol{\lambda} \in \textup{int}(\Lambda)$:
