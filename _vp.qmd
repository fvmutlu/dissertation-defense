...
**Approach:** Extending @yeh2014vip, minimize upper bound of [drift-plus-penalty]{.body-highlight}[^dpp] expression:
```{=tex}
\begin{equation*}
    \drift + \omega \pen
\end{equation*}
...
- Yields distributed algorithm with caching and forwarding subproblems solved at the beginning of each time slot.
:::
...
This is the well-known ***backpressure*** solution, also used in @yeh2014vip.
