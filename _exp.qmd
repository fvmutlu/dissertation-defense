...
![Cache capacity allocation in minimum delay point within budget.](images/alltops_075_15_table.svg){width=70% height=70% fig-align="center"}
...
::: {.incremental}
• Further requests (interests) are enqueued if there is already one in-flight.

[• Returning data satisfies all enqueued requests.]{.fragment fragment-index=2}
:::
