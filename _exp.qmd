...
[Cache capacity budget]{.body-highlight} $\Delta L = \Delta L_1 + \Delta L_2$ to allow comparisons with single tier setup; based on the large purchasing cost ratio of DRAM to flash.
...
::: {style="font-size: 80%; text-align: center"}
Cache hits and delay due to cache reads for multi-tiered cases.
...
::: columns
::: {.column width="47%"}
![Cache hits](images/size_comp_geant_075_15_replacements.svg)
:::
::: {.column width="53%"}
![Second tier read delays](images/size_comp_geant_075_15_hit_delays.svg)
:::
...
• *Line-rate* caching offsets aggregation benefit; effect is proportional with capacity[^agg].
